...
public class MinusOperation implements StrategyGameType {
    ...
    public MinusOperation(Context context) {
    ...
    public List<Integer> random(int lavel) {
        ...
        list.add(Math.max(tempNumb1, tempNumb2));
        list.add(Math.min(tempNumb1, tempNumb2));
